...
import './DashboardRegistrationForm.scss';
...
export class DashboardRegistrationFormWrapper extends Component<IDashboardRegistrationForm> {
	...
	render() {
		return (
			<div className="DashboardRegistrationForm">
				<hr className="DashboardRegistrationForm__separator" />
				<form className='form' onSubmit={this.onSubmit} onReset={this.onReset}>
					<div className="group">
						...
						<div className='form-group'>
							...
							<div className='form-input-group form-input-group-radio'>
